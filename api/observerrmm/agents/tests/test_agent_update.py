...
class TestAgentUpdate(ObserverTestCase):
    def setUp(self) -> None:
        self.authenticate()
    ...
    def test_do_update(self, mock_agent_url, mock_nats_cmd):
        ...
        mock_nats_cmd.assert_called_with(
            {
                ...
                "payload": {
                    ...
                    "version": settings.LATEST_AGENT_VER,
                    "inno": f"observeragent-v{settings.LATEST_AGENT_VER}-windows-amd64.exe",
                },
            },
            wait=False,
        )
        ...
        self.assertEqual(
            ...
            f"observeragent-v{settings.LATEST_AGENT_VER}-windows-amd64.exe",
        )
        ...
        mock_nats_cmd.assert_called_with(
            {
                ...
                "payload": {
                    "url": "https://example.com/123",
                    "version": settings.LATEST_AGENT_VER,
                    "inno": f"observeragent-v{settings.LATEST_AGENT_VER}-linux-arm.exe",
                },
            },
            wait=False,
        )
        ...
        self.assertEqual(
            ...
            f"observeragent-v{settings.LATEST_AGENT_VER}-linux-arm.exe",
        )
