...
from observerrmm.constants import DebugLogLevel, DebugLogType, PAAction, PAStatus
from observerrmm.test import ObserverTestCase

base_url = "/logs"


class TestAuditViews(ObserverTestCase):
    def setUp(self):
        self.authenticate()
    ...
    def test_cancel_pending_action(self, nats_cmd):
        ...
        action = baker.make(
            ...
            details={
                ...
                "taskname": "ObserverRMM_SchedReboot_wYzCCDVXlc",
            },
        )
        ...
        nats_data = {
            "func": "delschedtask",
            "schedtaskpayload": {"name": "ObserverRMM_SchedReboot_wYzCCDVXlc"},
        }
...
class TestLogTasks(ObserverTestCase):
