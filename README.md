...
**Versión actual: 1.4.11** · [Releases](https://github.com/braincorp-cl/observer-rmm-dist/releases) · [Changelog](https://agents.observer.cl/changelog/) · [Agente](https://github.com/braincorp-cl/observer-agent-dist/releases) (el producto ofrece la v2.15.20)
