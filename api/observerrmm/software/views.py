...
from observerrmm.constants import AgentHistoryType, PAAction
...
class UninstallSoftware(APIView):
    ...
    def post(self, request, agent_id):
        ...
        if all(i in uninstall_cmd.lower() for i in ("observeragent", "unins")):
            return notify_error(
                "The Observer RMM Agent cannot be uninstalled from here."
            )
