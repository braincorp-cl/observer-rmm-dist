...
from observer.constants import CustomFieldModel, CustomFieldType
from observer.helpers import make_random_password
...
TEST_CACHE = {
    "default": {
        "BACKEND": "observer.cache.TacticalDummyCache",
    }
}
