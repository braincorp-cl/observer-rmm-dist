...
from observerrmm.constants import AGENT_STATUS_ONLINE, DebugLogType
...
def auto_approve_updates_task() -> None:
    ...
    if getattr(settings, "ORMM_DISABLE_APPROVE_UPDATES_TASK", False):
        return
...
def check_agent_update_schedule_task() -> None:
    ...
    if getattr(settings, "ORMM_DISABLE_WINUPDATES_INSTALL_TASK", False):
        return
