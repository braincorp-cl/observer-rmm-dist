...
class TestAgentsList(ObserverTestCase):
    def setUp(self) -> None:
        self.authenticate()
...
class TestAgentViews(ObserverTestCase):
    def setUp(self):
        self.authenticate()
        self.setup_coresettings()
    ...
    def test_get_processes(self, mock_ret):
        ...
        with open(
            os.path.join(settings.BASE_DIR, "observerrmm/test_data/procs.json")
        ) as f:
    ...
    def test_get_event_log(self, nats_cmd):
        ...
        with open(
            os.path.join(settings.BASE_DIR, "observerrmm/test_data/appeventlog.json")
        ) as f:
...
class TestAgentViewsNew(ObserverTestCase):
    def setUp(self):
        self.authenticate()
        self.setup_coresettings()
...
class TestAgentPermissions(ObserverTestCase):
    def setUp(self):
        self.setup_client()
        self.setup_coresettings()
...
class TestAgentTasks(ObserverTestCase):
    def setUp(self):
        self.authenticate()
        self.setup_coresettings()
