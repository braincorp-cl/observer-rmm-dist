...
| Gates de CI del producto (Python, Go, Ansible) | verdes |
| Despliegue a *staging* (API + frontend) | `ORMM_VERSION 1.4.13` por la API; panel accesible en la consola |
| Panel de flota en la UI | filtros por estado/cliente/sitio y estados con color, verificado en pantalla |
| Detalle por equipo en la UI | volúmenes, última medición e historial se renderizan |
