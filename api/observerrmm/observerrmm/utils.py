...
from observerrmm.celery import app as celery_app
...
from observerrmm.helpers import (
    get_certs,
    get_nats_hosts,
...
def generate_winagent_exe(
    *,
    ...
    inno = (
        f"observeragent-v{settings.LATEST_AGENT_VER}-{AgentPlat.WINDOWS}-{goarch}.exe"
    )
