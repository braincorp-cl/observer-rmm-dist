...
from observerrmm.demo_data import (
...
WMI_1 = settings.BASE_DIR.joinpath("observerrmm/test_data/wmi1.json")
WMI_2 = settings.BASE_DIR.joinpath("observerrmm/test_data/wmi2.json")
WMI_3 = settings.BASE_DIR.joinpath("observerrmm/test_data/wmi3.json")
SW_1 = settings.BASE_DIR.joinpath("observerrmm/test_data/software1.json")
SW_2 = settings.BASE_DIR.joinpath("observerrmm/test_data/software2.json")
WIN_UPDATES = settings.BASE_DIR.joinpath("observerrmm/test_data/winupdates.json")
EVT_LOG_FAIL = settings.BASE_DIR.joinpath(
    "observerrmm/test_data/eventlog_check_fail.json"
)
