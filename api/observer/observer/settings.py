...
from observer.util_settings import get_backend_url, get_root_domain, get_webdomain
...
LOG_DIR = os.path.join(BASE_DIR, "observer/private/log")

EXE_DIR = os.path.join(BASE_DIR, "observer/private/exe")
...
# Agent check-in intervals (seconds). Overridable in local_settings.py.
# CHECKIN_SYNCMESH minimum 3600s — prevents OOM at scale (MINSAL lesson: 200-400s caused OOM with 28k agents)
CHECKIN_HELLO = (30, 60)
...
CHECKIN_SYNCMESH = (3600, 3600)

DEFAULT_AUTO_FIELD = "django.db.models.AutoField"

ASGI_APPLICATION = "observer.asgi.application"
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, "observer/static/")]
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": (
        ...
        "observer.auth.APIAuthentication",
    ),
...
SPECTACULAR_SETTINGS = {
    ...
    "AUTHENTICATION_WHITELIST": ["observer.auth.APIAuthentication"],
}
...
CACHES = {
    "default": {
        "BACKEND": "observer.cache.TacticalRedisCache",
...
MIDDLEWARE = [
    ...
    "observer.middleware.LogIPMiddleware",
    "django.middleware.common.CommonMiddleware",
    "django.middleware.csrf.CsrfViewMiddleware",
    "django.contrib.auth.middleware.AuthenticationMiddleware",
    "observer.middleware.AuditMiddleware",
...
if DEMO:
    MIDDLEWARE += ("observer.middleware.DemoMiddleware",)
