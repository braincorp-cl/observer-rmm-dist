        ...
        <template v-slot:after>
          ...
          >
            <q-tab
              ...
              :label="$t('policyOverview.tabChecks')"
            />
            <q-tab
              name="tasks"
              icon="fas fa-tasks"
              :label="$t('policyOverview.tabTasks')"
            />
          </q-tabs>
          <q-tab-panels
            v-model="selectedTab"
      ...
      for (let client of data) {
        ...
        if (!!client.server_policy) {
          ...
          if (!client.server_policy.active) {
            disabled = this.$t("policyOverview.disabledSuffix");
          }

          const label =
            client.server_policy.name +
            this.$t("policyOverview.serversSuffix") +
            disabled;
        ...
        if (!!client.workstation_policy) {
          ...
          const label =
            client.workstation_policy.name +
            this.$t("policyOverview.workstationsSuffix") +
            disabled;
          client_temp["children"].push({
            label: label,
            icon: "policy",
